    ...
    <Grid container className="welcome-page">
      <Grid item xs={12} lg={7} className="left-side">
        ...
        <div className="welcome-text">
          <div className="text">Learning English is tough</div>
          <div className="text">Learning you've just found</div>
          <div className="text">Be The Best English</div>
          <div className="icon-wrapper">
            <ArrowDropDownCircleOutlinedIcon className="done-icon" />
          </div>
        </div>
      </Grid>
