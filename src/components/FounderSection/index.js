  ...
  return (
    <Grid container className="founder-section">
      <Grid item xs={12} lg={5} className="left-side">
        ...
        <div className="description-text">Trần Nguyễn Phước</div>
      ...
      <Grid item xs={12} lg={7} className="right-side">
        ...
        <div className="kap-section">
          <div className="a-letter-section k-letter ">
            ...
            <div className="text-detail">Knowledge </div>
            <div className="vietsub">( Kiến thức )</div>
            <div className="k-line"></div>
          </div>
          <div className="a-letter-section a-letter">
            <div className="big-letter ">A</div>
            <div className="text-detail">Assurance</div>
            <div className="vietsub">( Tự tin )</div>
            <div className="a-line"></div>
          </div>
          <div className="a-letter-section  p-letter">
            <div className="big-letter">P</div>
            <div className="text-detail">Practice </div>
            <div className="vietsub">( Thực hành )</div>
            <div className="p-line"></div>
          </div>
        </div>
        <div className="line"></div>
        <div className="fluency-text">
          <div className="text-detail">Fluency </div>
          <div className="vietsub">( Sự lưu loát )</div>
        </div>
      </Grid>
    </Grid>
  );
